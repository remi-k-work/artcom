...
const draw = {
  ...
  visible: { pathLength: 1, opacity: 1, transition: { pathLength: { type: "spring", duration: 10, bounce: 0 }, opacity: { duration: 0.01 } } },
};

export default function References() {
  return (
    <motion.article initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 3, type: "spring" }} className={styles["references"]}>
