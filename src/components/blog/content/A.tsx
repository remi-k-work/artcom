  ...
  return (
    <Details>
      ...
      <Details.Content2>
        ...
        <p>
          Jeśli chcesz, możesz policzyć również cenę <b>1 cm2</b> każdej z pizz. W tym celu w komórce <b>F2</b> należy wpisać formułę, która podzieli pole pizzy
          przez jej cenę. Czyli w komórce <b>F2</b> wpisuję następującą formułę: <b>=E2/D2</b>. Skopiuj tę formułę też do komórki <b>F3</b>.
        </p>
        <p>
